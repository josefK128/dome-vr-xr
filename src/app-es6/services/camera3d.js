            ...
            class Camera3d {
                ...
                initialize(_lens, _csphere, _animation) {
                    ...
                    System.import(config._map)
                        ...
                        .catch((e) => {
                        mediator_1.mediator.loge(`camera3d: import of keymap caused error: ${e}`);
                    });
                } //initialize
                ...
                dollyflyTo(a) {
                    ...
                    mediator_1.mediator.log(`dollyflyTo: shot = ${shot}`);
                    animation.perform(shot);
                }
                dollyflyBy(a) {
                    a.d = a.d || 3.0;
                    ...
                    mediator_1.mediator.log(`dollyflyBy: shot = ${shot}`);
                    animation.perform(shot);
                }
                ...
                dollycutTo(a) {
                    ...
                    mediator_1.mediator.log(`dollycutTo: shot = ${shot}`);
                    animation.perform(shot);
                }
                dollycutBy(a) {
                    a.d = 0.0;

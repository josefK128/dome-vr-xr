        ...
        execute: function() {
            ...
            class VRVrStage {
                ...
                delta(state = {}, narrative, callback) {
                    mediator_1.mediator.log(`VRVrStage.delta: state = ${state}`);
                    async.parallel({
                        frame: function (callback) {
                            try {
                                ...
                                mediator_1.mediator.loge(`vrstage.delta caused error: ${e}`);
                                callback(null, {});
                            }
                        },
                        ...
                        actors: function (callback) {
                            try {
                                if (state['actors']) {
                                    // 4th var is vr=true!
                                    actors_1.actors.create(state['actors'], narrative, callback, true);
                                }
                                else {
                                    callback(null, {});
                                }
                        ...
                        mediator_1.mediator.log(`vrstage: o['environemt']['axes'] = ${o['environment']['axes']}`);
                        mediator_1.mediator.log(`vrstage: o['environemt']['ambient_light'] = ${o['environment']['ambient_light']}`);
                        mediator_1.mediator.log(`vrstage: o['environemt']['fog'] = ${o['environment']['fog']}`);
                        mediator_1.mediator.log(`vrstage: o['skycube']['skycube'] = ${o['skycube']['skycube']}`);
                        mediator_1.mediator.log(`vrstage: o['skydome']['skydome'] = ${o['skydome']['skydome']}`);
                        callback(null, {
            ...
            exports_1("vrstage", vrstage);
        }
    }
});
//# sourceMappingURL=vrstage.js.map
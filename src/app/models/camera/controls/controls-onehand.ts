...
var controls:LeapTwoHandControls,
    ...
    translationSpeed = .01, //10, //5.0; //2 //20;
    rotationSpeed = 1.0,  //4;
    transSmoothing = 0.000025, //0.0025, //0.025;  //.05 //0.5
    rotationSmoothing = 0.001, //0.01;  //.02 //0.2
    ...
    rotationMomentum = new THREE.Quaternion(),
    translationMomentum = new THREE.Vector3(),
    scaleMomentum = new THREE.Vector3(1, 1, 1),
...
//    object.quaternion.normalize();
  ...
  applyTranslation(anchorHands, hands) {
    var isEngaged = controls.isEngaged.bind(this);
    var translation = controls.getTranslation(
